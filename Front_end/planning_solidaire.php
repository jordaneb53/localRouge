...
<head>
    ...
    <script src="assets/js/calendrierSolidaire.js" defer></script>
    ...
    <main>
        ...
        <div class="calendar">
            <div class="navigation">
                ...
                <span id="currentWeekSolidaire">Semaine du 10 au 14 octobre 2023</span>
                <button id="nextWeekSolidaire">Suivant →</button>
            </div>
            <div class="schedule" id="scheduleContainerSolidaire">
